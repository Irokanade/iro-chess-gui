...
public final class NativeMoveGen {
    ...
    // Move generation — writes raw move ints into buffer, returns count
    // Move format: flags[15:12] | from[11:6] | to[5:0]
    public static native int generateLegalMoves(long positionPtr, int[] buffer);
